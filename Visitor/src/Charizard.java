...
public class Charizard extends State{
	...
	public int lepaa() {
		System.out.println(nimi + " lepää. Exp vähenee -3.");
		return -3;
	}
	
	public int kaytaHeikkoIsku() {
		System.out.println(nimi + " tekee heikon iskun.  Exp lisääntyy 7.");
		return 7;
	}
	
	public int kaytaVahvaIsku() {
		System.out.println(nimi + " tekee vahvan iskun. Exp lisääntyy 13.");
		return 13;
	}
